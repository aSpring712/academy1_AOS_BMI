...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter=ArrayAdapter.createFromResource(this, R.array.blood_array,
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(edt1.getText().toString().equals("")||
                    ...
                    tv2.setText("2. 신체 질량 지수는 " + Math.round(bmi*10)/10F + " 입니다");
                }
                ...
                if(chk2.isChecked()){
                    mThumblds.add(R.drawable.smoking);
                }
                if(!chk3.isChecked()){
                    mThumblds.add(R.drawable.workout);
                }
